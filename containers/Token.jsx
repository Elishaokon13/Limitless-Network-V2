		...
		<section id='section-token' className='section-padding'>
			...
			<div className='token'>
				...
				<div className='token__content'>
					...
					<div className='token'>
						<div className='token__content'>
							<h5 className='mt-8'>NOTE:</h5>
							<p>
								LNT investors are not penalized by sells, buy-backs, or wallet-redistributions and transfers.
								<br />
								<b>Disclaimer: Reward benefits from reward Tiers 1,2 and 3 may be subject to change based amount of holders and total profits generated from the limitless Network mining facility</b>
							</p>						
						</div>
					</div>
				</div>
